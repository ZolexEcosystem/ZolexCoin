...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000dbaf2506cd18e7bf2fd376465affa136322a0517d2c83a0b10417888e4b"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1548840412, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("045537b8791d3d99244126d81bd8ec43aada5d7d8f332bd34e51b62bdfaae49484e7229d831845d852219a5f1d491d0bc67a01b1ee82a9c95edf56a861da36a092");
        nDefaultPort = 33342;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 ZolexCoin starting difficulty is 1 / 2^12
        ...
        nTargetSpacingSlowLaunch = 1 * 120;
        ...
        nZerocoinStartTime = 1648840412;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "ZolexCoin January 2019 - New Chain started";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04ae141b9c6dc016636de3bbbd05b707fcfa1ae4d829199d222daeb21b48d57365d32afdd8e53a0f6f37152dbef7bb57eab00bb7aae71e7f77ba443206840bfb6a") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1548840412;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 297437;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000dbaf2506cd18e7bf2fd376465affa136322a0517d2c83a0b10417888e4b"));
        assert(genesis.hashMerkleRoot == uint256("0x2f8bc88bc155abf6929b857b3dd1a3633e0bdbe5ea3ce14bd575a45a506cc48c"));

	vSeeds.push_back(CDNSSeedData("155.138.162.119", "155.138.162.119"));
        vSeeds.push_back(CDNSSeedData("45.76.47.92", "45.76.47.92"));
        vSeeds.push_back(CDNSSeedData("209.250.229.187", "209.250.229.187"));
	...
	strSporkKey = "04E19A08F976BF9780B923758AE5AC079F394AF7F89C6A85645C2611B48E702D80E393EE7E0C0C12FEE9A6D423284295403E58779CB72918A6EA3B2AD6D1E8544B";
        strObfuscationPoolDummyAddress = "ZY8WevdmT9HyZimt24qCegq2hwC3gK5NGT";
        nStartMasternodePayments = 1548840412;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ZolexCoin: 1 day
        nTargetSpacing = 1 * 60;  // ZolexCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet zolexcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet zolexcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet zolexcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet zolexcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet zolexcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // ZolexCoin: 1 day
        nTargetSpacing = 1 * 60;        // ZolexCoin: 1 minutes
