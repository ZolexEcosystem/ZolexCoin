...
/** Utility functions used by the ZolexCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ZolexCoin addresses in monospace font
...
// Parse "zolexcoin:" URI into recipient object, return true on successful parsing
