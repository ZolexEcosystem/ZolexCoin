                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZolexCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZolexCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zolexcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZolexCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZolexCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZolexCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZolexCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZolexCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZolexCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZolexCoin Core help message to get a list with possible ZolexCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZolexCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZolexCoin network", "", count));
}
...
{
    QString strTitle = tr("ZolexCoin Core"); // default title
...
/** Creates context menu, its actions, and zolexcoins up all the relevant signals for mouse events. */
