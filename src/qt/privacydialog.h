...
public:
    ...
    void setZZolexCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzZLX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzZLX_clicked();
    void on_pushButtonZZolexCoinControl_clicked();
