...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ZolexCoin Core zolexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zolexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zolexcoin transaction") + "\n" +
                               "  zolexcoin-tx [options] -create [commands]   " + _("Create hex-encoded zolexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zolexcoin transaction
