...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ZolexCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ZolexCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZolexCoin features */
        {"zolexcoin", "masternode", &masternode, true, true, false},
        {"zolexcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"zolexcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zolexcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zolexcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zolexcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"zolexcoin", "startmasternode", &startmasternode, true, true, false},
        {"zolexcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zolexcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zolexcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zolexcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zolexcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zolexcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zolexcoin", "mnbudget", &mnbudget, true, true, false},
        {"zolexcoin", "preparebudget", &preparebudget, true, true, false},
        {"zolexcoin", "submitbudget", &submitbudget, true, true, false},
        {"zolexcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zolexcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zolexcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zolexcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zolexcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zolexcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zolexcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zolexcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"zolexcoin", "mnsync", &mnsync, true, true, false},
        {"zolexcoin", "spork", &spork, true, true, false},
        {"zolexcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zolexcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zolexcoind, or the -server option to zolexcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zolexcoin-cli " + methodname + " " + args + "\n";
}
