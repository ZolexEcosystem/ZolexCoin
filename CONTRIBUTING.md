Contributing to ZolexCoin Core
============================

The ZolexCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZolexCoin Core project, and is not to be
confused with overall ZolexCoin Network Protocol consensus changes.

Whether a pull request is merged into ZolexCoin Core rests with the project merge
...
Patches that change ZolexCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZolexCoin consensus, it must have been
...
The project leader is the release manager for each ZolexCoin Core release.
